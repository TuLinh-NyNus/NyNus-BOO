...
# Location: docker/scripts/docker-dev.ps1
...
function Show-Help {
    ...
    Write-ColorOutput "  .\docker\scripts\docker-dev.ps1                # Start development services" "White"
    Write-ColorOutput "  .\docker\scripts\docker-dev.ps1 -Build         # Force rebuild and start" "White"
    Write-ColorOutput "  .\docker\scripts\docker-dev.ps1 -Stop          # Stop all services" "White"
    Write-ColorOutput "  .\docker\scripts\docker-dev.ps1 -Logs          # Show service logs" "White"
    Write-ColorOutput "  .\docker\scripts\docker-dev.ps1 -Status        # Show service status" "White"
    Write-ColorOutput "  .\docker\scripts\docker-dev.ps1 -Clean         # Clean up everything" "White"
    Write-ColorOutput "  .\docker\scripts\docker-dev.ps1 -Help          # Show this help" "White"
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-ColorOutput "  .\docker\scripts\docker-dev.ps1 -Logs    # View logs" "White"
    Write-ColorOutput "  .\docker\scripts\docker-dev.ps1 -Status  # Check status" "White"
    Write-ColorOutput "  .\docker\scripts\docker-dev.ps1 -Stop    # Stop services" "White"
} else {
