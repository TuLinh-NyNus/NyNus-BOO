...
def test_with_file(file_path: str, output_dir: str = "output"):
    ...
    try:
        ...
        print("\n🔧 Importing modules...")
        from src.processor.file_reader import FileReader
        from src.processor.batch_processor import BatchProcessor
        from src.processor.error_handler import ErrorHandler
        from src.export.csv_exporter import CSVExporter
        from src.export.data_validator import DataValidator
