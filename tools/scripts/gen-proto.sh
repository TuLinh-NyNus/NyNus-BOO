...
# Use official genproto package for google.api instead of generating locally
GO_GOOGLE_API_PKG="google.golang.org/genproto/googleapis/api/annotations"
...
for proto_file in "$PROTO_DIR/v1"/*.proto; do
    if [ -f "$proto_file" ]; then
        ...
        # Map google.api imports to official genproto package to avoid proto namespace conflicts
