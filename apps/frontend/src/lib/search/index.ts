...
import { TIMEOUTS, SEARCH_CONSTANTS as SHARED_SEARCH_CONSTANTS } from '@/lib/constants/timeouts';

export const SEARCH_CONSTANTS = {
  MAX_RESULTS: SHARED_SEARCH_CONSTANTS.MAX_RESULTS,
  MIN_RELEVANCE: SHARED_SEARCH_CONSTANTS.MIN_RELEVANCE,
  CACHE_SIZE: SHARED_SEARCH_CONSTANTS.CACHE_SIZE,
  SEARCH_TIMEOUT: TIMEOUTS.SEARCH_TIMEOUT_MS,
  DEBOUNCE_DELAY: TIMEOUTS.SEARCH_DEBOUNCE_MS,
