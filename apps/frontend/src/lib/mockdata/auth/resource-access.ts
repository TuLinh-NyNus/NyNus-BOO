...
import { ResourceAccess, ResourceAccessStats, MockPagination, MockApiResponse } from '../shared/core-types';
...
export function getHighRiskResourceAccess(threshold: number = 80): ResourceAccess[] {
