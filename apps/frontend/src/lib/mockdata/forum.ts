...
import { AdminForumPost, MockPagination, MockApiResponse } from './types';
...
export const mockForumPosts: AdminForumPost[] = [
  {
    ...
    authorAvatar: '/avatars/student-001.jpg',
    category: 'Toán học',
    ...
    replies: [
      {
        ...
        authorAvatar: '/avatars/student-004.jpg',
      ...
      },
      {
        ...
        authorAvatar: '/avatars/instructor-001.jpg',
  ...
  },
  {
    ...
    authorAvatar: '/avatars/student-002.jpg',
    category: 'Vật lý',
    ...
    replies: [
      {
        ...
        authorAvatar: '/avatars/instructor-002.jpg',
        isInstructorReply: true,
        likes: 34,
  ...
  },
  {
    ...
    authorAvatar: '/avatars/student-005.jpg',
    category: 'Tài liệu',
    ...
    replies: [
      {
        ...
        authorAvatar: '/avatars/student-006.jpg',
        isInstructorReply: false,
        likes: 12,
  ...
  },
  {
    ...
    authorAvatar: '/avatars/admin-002.jpg',
    category: 'Thông báo',
    ...
    replies: [
      {
        ...
        authorAvatar: '/avatars/student-007.jpg',
        isInstructorReply: false,
        likes: 23,
  ...
  },
  {
    ...
    authorAvatar: '/avatars/student-003.jpg',
    category: 'Hóa học',
    ...
    replies: [
      {
        ...
        authorAvatar: '/avatars/instructor-003.jpg',
        isInstructorReply: true,
        likes: 18,
