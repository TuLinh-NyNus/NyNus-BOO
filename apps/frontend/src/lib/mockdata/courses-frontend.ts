...
import { MockCourse, MockChapter, MockLesson, MockResource, MockReview, MockTutorial } from './courses-types';
...
export const mockTutorials: MockTutorial[] = [
  {
    ...
    level: 'Cơ bản',
    instructor: 'Lê Văn Toán',
    thumbnail: '/tutorials/ham-so-intro.jpg',
  ...
  },
  {
    ...
    level: 'Trung bình',
    instructor: 'Lê Văn Toán',
    thumbnail: '/tutorials/dao-ham.jpg',
