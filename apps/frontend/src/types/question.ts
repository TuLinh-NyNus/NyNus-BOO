...
export enum QuestionType {
  ...
  MULTIPLE_CHOICE = 'MULTIPLE_CHOICE', // Alternative name for compatibility
  TF = 'TF', // True/False
  SA = 'SA', // Short Answer
  ES = 'ES', // Essay
  MA = 'MA'  // Matching
...
// Sort field type for question lists
export type SortField = 'createdAt' | 'updatedAt' | 'difficulty' | 'type' | 'content';
