/**
 * Multiple Choice Display Component
 * Specialized rendering cho Multiple Choice questions
 * 
 * @author NyNus Team
 * @version 1.0.0
 */
...
import { CheckCircle, Circle, AlertCircle, Eye, EyeOff } from 'lucide-react';
import { LaTeXRenderer } from '@/components/ui/latex';
import { AnswerOption } from '@/types/question';

/**
 * Props cho Multiple Choice Display
 */
...
/**
 * Multiple Choice Display Component
 * Hiển thị câu hỏi trắc nghiệm với LaTeX support
 */
export function MultipleChoiceDisplay({
  ...
  return (
    <div className={`multiple-choice-display space-y-3 ${className}`}>
...
/**
 * Multiple Choice Preview Component
...
export function MultipleChoicePreview({
  ...
  return (
    <div className={`multiple-choice-preview ${className}`}>
