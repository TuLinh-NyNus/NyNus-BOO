...
const (
	...
	BookService_IncrementDownloadCount_FullMethodName = "/v1.BookService/IncrementDownloadCount"
)
...
type BookServiceClient interface {
	...
	IncrementDownloadCount(ctx context.Context, in *IncrementDownloadCountRequest, opts ...grpc.CallOption) (*IncrementDownloadCountResponse, error)
}
...
func (c *bookServiceClient) IncrementDownloadCount(ctx context.Context, in *IncrementDownloadCountRequest, opts ...grpc.CallOption) (*IncrementDownloadCountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IncrementDownloadCountResponse)
...
type BookServiceServer interface {
	...
	// Increment download count (public)
	IncrementDownloadCount(context.Context, *IncrementDownloadCountRequest) (*IncrementDownloadCountResponse, error)
}
...
func (UnimplementedBookServiceServer) IncrementDownloadCount(context.Context, *IncrementDownloadCountRequest) (*IncrementDownloadCountResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IncrementDownloadCount not implemented")
}
