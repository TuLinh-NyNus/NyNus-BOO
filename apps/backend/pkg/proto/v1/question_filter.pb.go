...
const file_v1_question_filter_proto_rawDesc = "" +
	...
	"usageCount\x12\x18\n" +
	"\acreator\x18\f \x01(\tR\acreator\x12.\n" +
	"\x06status\x18\r \x01(\x0e2\x16.common.QuestionStatusR\x06status\x12\x1a\n" +
	"\bfeedback\x18\x0e \x01(\x05R\bfeedback\x127\n" +
	"\n" +
	...
	"\x05types\x18\x01 \x03(\x0e2\x14.common.QuestionTypeR\x05types\x122\n" +
	"\bstatuses\x18\x02 \x03(\x0e2\x16.common.QuestionStatusR\bstatuses\x12;\n" +
	"\fdifficulties\x18\x03 \x03(\x0e2\x17.common.DifficultyLevelR\fdifficulties\x12\x1a\n" +
