...
const file_v1_user_proto_rawDesc = "" +
	...
	"\n" +
	"UpdateUser\x12\x15.v1.UpdateUserRequest\x1a\x16.v1.UpdateUserResponseB|\n" +
	"\x06com.v1B\tUserProtoP\x01Z?github.com/AnhPhan49/exam-bank-system/apps/backend/pkg/proto/v1\xa2\x02\x03VXX\xaa\x02\x02V1\xca\x02\x02V1\xe2\x02\x0eV1\\GPBMetadata\xea\x02\x02V1b\x06proto3"
