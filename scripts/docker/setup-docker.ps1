...
"@
    ...
    Set-Content -Path "docker/compose/docker-compose.yml" -Value $dockerCompose -Encoding UTF8
    Write-ColorOutput "[OK] docker/compose/docker-compose.yml updated" "Green"
}
...
function Clean-Services {
    ...
    docker-compose -f docker/compose/docker-compose.yml down --rmi all
...
function Show-Status {
    ...
    $containers = docker-compose -f docker/compose/docker-compose.yml ps --format "table"
    if ($containers) {
