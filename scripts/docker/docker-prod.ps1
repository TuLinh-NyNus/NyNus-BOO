...
function Show-Help {
    ...
    Write-ColorOutput "  .\docker-prod.ps1                # Start production services" "White"
    Write-ColorOutput "  .\docker-prod.ps1 -Build         # Force rebuild and start" "White"
    Write-ColorOutput "  .\docker-prod.ps1 -Stop          # Stop all services" "White"
    Write-ColorOutput "  .\docker-prod.ps1 -Logs          # Show service logs" "White"
    Write-ColorOutput "  .\docker-prod.ps1 -Status        # Show service status" "White"
    Write-ColorOutput "  .\docker-prod.ps1 -Clean         # Clean up everything" "White"
    Write-ColorOutput "  .\docker-prod.ps1 -Help          # Show this help" "White"
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-ColorOutput "  .\docker-prod.ps1 -Logs    # View logs" "White"
    Write-ColorOutput "  .\docker-prod.ps1 -Status  # Check status" "White"
    Write-ColorOutput "  .\docker-prod.ps1 -Stop    # Stop services" "White"
} else {
