...
export function FilePreview({ 
      ...
      case 'link':
        return (
          <div className="relative overflow-hidden rounded-lg bg-slate-900">
            ...
            />
            <div className="hidden flex items-center justify-center h-96 bg-slate-700/50">
              <div className="text-center space-y-2">
                <AlertTriangle className="h-12 w-12 mx-auto text-yellow-400" />
                <p className="text-slate-400">Không thể tải hình ảnh</p>
              </div>
            </div>
          </div>
        );
        ...
        return (
          <div className="relative rounded-lg overflow-hidden bg-black">
            <video
              ...
              poster={`${file.url}-thumbnail.jpg`}
            >
              <source src={file.url} type="video/mp4" />
              <div className="flex items-center justify-center h-96 bg-slate-700/50">
                <div className="text-center space-y-2">
                  <Video className="h-12 w-12 mx-auto text-purple-400" />
                  <p className="text-slate-400">Trình duyệt không hỗ trợ video này</p>
                </div>
              </div>
            </video>
          </div>
          ...
          <div className="flex items-center justify-center h-96 bg-slate-700/50 rounded-lg">
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 break-all">{file.url}</p>
              </div>
              <Button
  ...
  const showImageControls = false; // file.type === 'image';
