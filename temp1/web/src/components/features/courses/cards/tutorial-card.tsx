...
import { MockTutorial } from "@/lib/mock-data/types";
...
// Grid container component for tutorials
...
export function TutorialGridSkeleton({ count = 9, className, variant = 'default' }: { count?: number; className?: string; variant?: 'default' | 'compact' }): JSX.Element {
  const gridClasses = variant === 'compact'
    ? "grid grid-cols-1 sm:grid-cols-2 gap-4"
    : "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6";
