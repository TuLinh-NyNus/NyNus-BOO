          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <Select value={filters.sortBy || 'number'} onValueChange={(value) => handleFilterChange('sortBy', value)}>
                  <SelectTrigger>
...
// Compact search bar for mobile or small spaces
export function CompactSearchBar({ onSearch, placeholder = "Tìm kiếm...", className }: Omit<SearchBarProps, 'showFilters' | 'variant'>): JSX.Element {
  return (
    <SearchBar
      onSearch={onSearch}
      placeholder={placeholder}
...
export function FloatingSearchBar({ onSearch, onFilter, placeholder, showFilters = true, className }: SearchBarProps): JSX.Element {
  return (
    <SearchBar
      onSearch={onSearch}
      onFilter={onFilter}
