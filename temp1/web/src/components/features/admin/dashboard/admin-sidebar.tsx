...
import { ChevronLeft, ChevronRight, LayoutDashboard, Users, BookOpen, FileText, GraduationCap, HelpCircle, BrainCircuit, MessageSquare, BarChart2, Settings, Database, MessagesSquare, Moon, Sun, LogOut, Map, Shield } from 'lucide-react';
          ...
          {menuItems.filter(item => !item.hidden).map((item) => (
            <Link
              ...
              className={cn(
                ...
                (pathname === item.href || pathname.startsWith(item.href + '/')) ? "bg-purple-100/50 dark:bg-purple-500/20 text-purple-600 dark:text-purple-400" : "text-slate-600 dark:text-slate-400",
                isCollapsed
                  ? "justify-center px-0"
                  : "px-3 gap-3"
              )}
